...
int misc_init_r(void)
{
	...
	ret = gpio_request(47,"850_light_gpio");
	printf("misc_init_r after gpio_request the 850_light_gpio ret is %d\n",ret);
	ret = gpio_direction_output(47,0);
	ret = gpio_get_value(47);
	printf("misc_init_r after change the 850_light_gpio ret is %d\n",ret);
#else
